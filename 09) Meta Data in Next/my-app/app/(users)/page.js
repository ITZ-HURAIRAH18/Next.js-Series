...
const TeamMemberCard = ({ member }) => {
  return (
    <div className= "  font-poppins bg-gray-800 rounded-lg p-6 flex flex-col items-center text-center shadow-lg transform hover:scale-105 transition-transform duration-300">
